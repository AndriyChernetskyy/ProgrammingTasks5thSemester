...
namespace Business_Layer.Services
{
    ...
    public class FigureService : IService<Polygon>
    {
        ...
        /// <inheritdoc/>
        public void AddFigure(Polygon entity)
        {
            this.figureRepository.AddFigure(entity);
        }
        ...
        /// <inheritdoc/>
        public void RemoveFigure(Polygon entity)
        {
            this.figureRepository.RemoveFigure(entity);
        }
        ...
        {
            this.figureRepository.RemoveAllFigures();
        }
